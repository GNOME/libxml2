...
the options it accepts and give a brief explanation of these. In every
...
"_xmlAddChild". The MSVC compiler does not have this behavior, and looks for
...
This behavior may not be supported in the future.
